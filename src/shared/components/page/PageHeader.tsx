...
const PageHeader: React.FC<PageHeaderProps> = ({ title, subtitle, extra, breadcrumbs, icon }) => {
  return (
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-gray-100">
      <div>
        {breadcrumbs && (
          <Breadcrumb
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col justify-center">
            <h5 className="!m-0 text-[22px] font-semibold tracking-tight text-gray-800 leading-tight">
              {title}
            </h5>
