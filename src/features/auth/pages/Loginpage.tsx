...
const Loginpage = () => {
  ...
  return (
    <CardCustom className="w-full max-w-105 mx-auto border border-white/60 bg-white/80! backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl p-4 sm:p-6">
